...
public class UserInfoAction extends BaseAction {
    ...
    public String QueryUserInfoOutputToExcel() { 
        ...
        for(int i=0;i<userInfoList.size();i++) {
        	...
        	dataset.add(new String[]{userInfo.getUser_name(),userInfo.getRealName(),userInfo.getSex(),new SimpleDateFormat("yyyy-MM-dd").format(userInfo.getBirthday()),userInfo.getCardNumber(),userInfo.getCity(),userInfo.getMoney() + "",userInfo.getUserPhoto(),userInfo.getAddress()});
        }
        /*
