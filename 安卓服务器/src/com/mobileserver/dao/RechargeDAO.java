...
public class RechargeDAO {
	...
	public String AddRecharge(Recharge recharge) {
		...
		try {
			/* 构建sql执行插入新充值信息 */
			String sqlString = "insert into Recharge(userObj,money,chargeTime) values (";
			sqlString += "'" + recharge.getUserObj() + "',";
			sqlString += recharge.getMoney() + ",";
			sqlString += "'" + recharge.getChargeTime() + "'";
			sqlString += ")";
