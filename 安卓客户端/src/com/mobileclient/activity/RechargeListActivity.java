...
import com.mobileclient.util.ActivityUtils;import com.mobileclient.util.RechargeSimpleAdapter;
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new RechargeSimpleAdapter(RechargeListActivity.this, list,
	        					R.layout.recharge_list_item,
	        					new String[] { "userObj","money","chargeTime" },
	        					new int[] { R.id.tv_userObj,R.id.tv_money,R.id.tv_chargeTime,},lv);
