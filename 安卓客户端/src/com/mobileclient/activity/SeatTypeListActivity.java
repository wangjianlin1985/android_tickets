...
import com.mobileclient.util.ActivityUtils;import com.mobileclient.util.SeatTypeSimpleAdapter;
		...
		new Thread(){
			...
			public void run() {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						dialog.cancel();
						adapter = new SeatTypeSimpleAdapter(SeatTypeListActivity.this, list,
	        					R.layout.seattype_list_item,
	        					new String[] { "seatTypeId","seatTypeName" },
	        					new int[] { R.id.tv_seatTypeId,R.id.tv_seatTypeName,},lv);
