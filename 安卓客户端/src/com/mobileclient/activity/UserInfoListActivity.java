				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new UserInfoSimpleAdapter(UserInfoListActivity.this, list,
	        					...
	        					new String[] { "user_name","realName","sex","birthday","city","money","userPhoto" },
	        					new int[] { R.id.tv_user_name,R.id.tv_realName,R.id.tv_sex,R.id.tv_birthday,R.id.tv_city,R.id.tv_money,R.id.iv_userPhoto,},lv);
