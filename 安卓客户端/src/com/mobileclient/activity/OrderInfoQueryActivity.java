...
public class OrderInfoQueryActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		spinner_startStation.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionOrderInfo.setStartStation(stationInfoList.get(arg2-1).getStationId()); 
				else
					queryConditionOrderInfo.setStartStation(0);
			}
			@Override
			public void onNothingSelected(AdapterView<?> arg0) {}
		});
		...
		spinner_endStation.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionOrderInfo.setEndStation(stationInfoList.get(arg2-1).getStationId()); 
				else
					queryConditionOrderInfo.setEndStation(0);
			}
			@Override
			public void onNothingSelected(AdapterView<?> arg0) {}
		});
		...
		spinner_seatType.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,int arg2, long arg3) {
				if(arg2 != 0)
					queryConditionOrderInfo.setSeatType(seatTypeList.get(arg2-1).getSeatTypeId()); 
				else
					queryConditionOrderInfo.setSeatType(0);
			}
			@Override
			public void onNothingSelected(AdapterView<?> arg0) {}
		});
		...
		btnQuery.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					/*获取查询参数*/
					queryConditionOrderInfo.setTrainNumber(ET_trainNumber.getText().toString());
					if(cb_startDate.isChecked()) {
						...
						queryConditionOrderInfo.setStartDate(new Timestamp(startDate.getTime()));
					} else {
						queryConditionOrderInfo.setStartDate(null);
					} 
